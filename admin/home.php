...
<head>
    ...
    <title>SsMo Administrator</title>
    <!-- Bootstrap Styles-->
                                ...
                                <div class='modal-dialog'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            ...
                                            <h4 class='modal-title' id='myModalLabel'>Change Username and Password</h4>
                                        </div>
										<form method='post>
                                        <div class='modal-body'>
                                            <div class='form-group'>
                                            <label>Change Username</label>
                                            <input name='username' value='<?php echo $fname; ?>' class='form-control' placeholder='Enter User name'>
											</div>
										</div>
										<div class='modal-body'>
                                            <div class='form-group'>
