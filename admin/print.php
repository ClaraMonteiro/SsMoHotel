...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>SsMo Hotel,</p>
				<p>New Castle Road,<br>Galway,<br>Ireland.</p>
				<p>(+91) 65 273 44 56</p>
			</address>
			<span><img alt="" src="assets/img/SSMO.jpg"></span>
		</header>
		<article>
			<h1>Recipient</h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@SsMoResort.com || Web :- www.SsMoResort.com || Phone :- +91 65 273 44 56 </p>
			</div>
		</aside>
	</body>
</html>
...
$free="Free";
$nul = null;
$rpsql = "UPDATE `room` SET `place`='$free',`customerid`='$nul' where `customerid`='$id'";
if(mysqli_query($con,$rpsql))
{
	$delsql= "DELETE FROM `bookroom` WHERE id='$id' ";
